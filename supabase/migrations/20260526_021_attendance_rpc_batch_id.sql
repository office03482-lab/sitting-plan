...
-- Add s.batch_id to the RPC result so Python post-filtering by batch_id can work.
...
is 'Optimized attendance report reader with batch_id in result set for batch-level post-filtering.';
